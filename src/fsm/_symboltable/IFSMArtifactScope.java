...
import de.monticore.symboltable.*;
 ...
 public  interface IFSMArtifactScope extends de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsArtifactScope,fsm._symboltable.IFSMScope  { 
...
;
...

 {
  ...
  List<de.monticore.symboltable.ISymbol> topSymbolList = new ArrayList<>();
    topSymbolList.addAll(getStateSymbols().values());
...

 {
  ...
  final List<fsm._symboltable.StateSymbol> result = new ArrayList<>();
...
if (!(getEnclosingScope() instanceof IGlobalScope)) {
  ...
  final List<fsm._symboltable.StateSymbol> resolvedFromEnclosing = getEnclosingScope().resolveStateMany(foundSymbols,
